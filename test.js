...
const SetCalculatedHp = () => 
{
  ...
  console.log("Straight Conveyor Length: ", straightConveyorLength);
  ...
  document.getElementById('standardHpCalculation').innerHTML ="((" + straightConveyorLength +
  " + " + futureExpansionLength + ") * " + coefficient + ") * " + commodityMultiplier;
